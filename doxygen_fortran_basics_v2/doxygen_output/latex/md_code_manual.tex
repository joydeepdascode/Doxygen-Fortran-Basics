\hypertarget{md_code_manual_autotoc_md0}{}\doxysection{Follow the below steps to reach the base HTML page\+:}\label{md_code_manual_autotoc_md0}
...
\item Click Next, check for HTML, Latex.
\item Click Next, check for diagrams to generate.
\item In the Expert Column, go to Project row, and enable \char`\"{}\+JAVADOC AUTOBRIEEF\char`\"{}.
\item In the Build row, check \char`\"{}\+EXTRACT\+\_\+\+ALL\char`\"{}. Uncheck \char`\"{}\+SHOW\+\_\+\+USED\+\_\+\+FILES\char`\"{}.
\item In the HTML row, check \char`\"{}\+GENERATE\+\_\+\+TREEVIEW\char`\"{}. And, Uncheck \char`\"{}\+DISABLE\+\_\+\+INDEX\char`\"{}.
\item Finally, Click on Run column.
\item Go to output folder, and open index.\+html to view the output.
\end{DoxyEnumerate}\hypertarget{md_code_manual_autotoc_md1}{}\doxysection{How to use Doxygen to create documentation of a source code(\+In Fortran)\+:}\label{md_code_manual_autotoc_md1}
\DoxyHorRuler{0}
...
Check the code of \mbox{\hyperlink{main_8_f90}{main.\+F90}} file, to see what is meant in the above {\bfseries{manual}}.\hypertarget{md_code_manual_autotoc_md4}{}\doxysection{Using Doxygen to create an Introduction to the source code(\+A Markdown File)\+:}\label{md_code_manual_autotoc_md4}
\DoxyHorRuler{0}
...
\begin{DoxyEnumerate}
\item {\bfseries{To create a mainpage}}\+: Create a \mbox{\hyperlink{mainpage_8md}{mainpage.\+md}} file in the Doxygen input directory. And inside teh file enter, \begin{DoxyVerb}@mainpage 
...
\end{DoxyEnumerate}\hypertarget{md_code_manual_autotoc_md7}{}\doxysection{Syntaxes}\label{md_code_manual_autotoc_md7}
