\label{md_code_page3_page3}%
\Hypertarget{md_code_page3_page3}%
 \hypertarget{md_code_page3_pg3}{}\doxysection{List of Some Syntaxes and Other relevant commands from Doxygen}\label{md_code_page3_pg3}
\DoxyHorRuler{0}
